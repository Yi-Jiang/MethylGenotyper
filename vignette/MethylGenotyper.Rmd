...
dosage_snp <- callGeno_snp(rgData, input="raw", vcf=TRUE, pop="EAS")
# Call genotypes for Type I CCS probes
dosage_typeI <- callGeno_typeI(rgData, vcf=TRUE, pop="EAS")
# Call genotypes for Type II CCS probes
dosage_typeII <- callGeno_typeII(rgData, input="raw", vcf=TRUE, pop="EAS")
# Combine genotypes inferred from the three probe types
dosage <- rbind(dosage_snp, dosage_typeI, dosage_typeII)
```
...
# Call genotypes for SNP probes
dosage_snp <- callGeno_snp(beta_matrix, input="beta", vcf=TRUE, pop="EAS")
# Call genotypes for Type II CCS probes
dosage_typeII <- callGeno_typeII(beta_matrix, input="beta", vcf=TRUE, pop="EAS")
# Combine genotypes inferred from the three probe types
