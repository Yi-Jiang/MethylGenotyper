...
callGeno_snp <- function(rgData, input="raw", plotBeta=FALSE, vcf=FALSE, vcfName="genotypes.snp_probe.vcf", 
                         GP_cutoff=0.9, R2_cutoff_up=1.1, R2_cutoff_down=0.75, MAF_cutoff=0.01, HWE_cutoff=1e-6, 
  ...
  dosage <- format_genotypes(genotypes, vcf=vcf, vcfName=vcfName, GP_cutoff=GP_cutoff, R2_cutoff_up=R2_cutoff_up, 
                             R2_cutoff_down=R2_cutoff_down, MAF_cutoff=MAF_cutoff, HWE_cutoff=HWE_cutoff, type="snp_probe",
