...
#' @export
callGeno_typeII <- function(rgData, input="raw", plotBeta=FALSE, vcf=FALSE, R2_cutoff_up=1.1, R2_cutoff_down=0.7, MAF_cutoff=0.01, train=FALSE, cpu=1, pop="ALL"){
  # calculate RAI
  if(input=="raw"){
  ...
  dosage <- format_genotypes(genotypes, vcf=vcf, R2_cutoff_up=R2_cutoff_up, R2_cutoff_down=R2_cutoff_down, MAF_cutoff=MAF_cutoff, type="typeII_probe")
  dosage
}
