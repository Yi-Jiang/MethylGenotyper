...
#'
#' @param snpmatrix A matrix of allelic balances for probes. Provide probes as rows and samples as columns.
...
#' @return A histogram showing the distribution of beta-values for SNP probes with the density function of the mixture model overlaid.
...
#' @rdname call_genotypes
#' @return A metric assessing the outlierness of the SNP beta-values. High values may indicate either contaminated or failed samples.
#' @export
